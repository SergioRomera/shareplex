...
if [ -f $SHAREPLEX_SOFTWARE ]; then
  ...
  # wget --header="Host: u3xduw.dm.files.1drv.com" \
       # --header="Referer: https://onedrive.live.com/" \
       # --header="Connection: keep-alive" "https://u3xduw.dm.files.1drv.com/y4mYgWETUbHKtXnCAqkzUs50vdO08lpaE4pR1TY18rD-VzQFtf2oQVeGyuUFwnLM4-pjMLV258Dwg9B0DZTXrzIL9wv9uNDiguJwCIB0B5y82pGoQxlTgF034MST-eRWSBkoLGhz8E2MvlLtQgsv8v-HIkkNz_jFoMPYxRaLLTWJfJ2--X-3q881BSWZdFyj5dM/SharePlex-latest.tpm?download&psid=1" \
       # -O "SharePlex-latest.tpm" \
       # -c -q

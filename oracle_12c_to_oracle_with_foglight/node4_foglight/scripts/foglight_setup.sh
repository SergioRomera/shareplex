...
echo "Cartridges" `date`
echo "******************************************************************************"
./fglcmd.sh -usr foglight -cmd cartridge:enable -n DB_Oracle -v 5.9.5.20
./fglcmd.sh -usr foglight -cmd cartridge:enable -n DB_Oracle_UI -v 5.9.5.20
./fglcmd.sh -usr foglight -cmd cartridge:enable -n DB_SQL_Server -v 5.9.5.20
./fglcmd.sh -usr foglight -cmd cartridge:enable -n DB_SQL_Server_UI -v 5.9.5.20
./fglcmd.sh -usr foglight -cmd cartridge:enable -n PostgreSQLAgent -v 5.9.4.10

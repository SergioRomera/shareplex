...
/opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P $MSSQL_SA_PASSWORD -i /vagrant/scripts/create_database_test.sql
/opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P $MSSQL_SA_PASSWORD -i /vagrant/scripts/create_tables_test.sql
echo "AdventureWorks test created."

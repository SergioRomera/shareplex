function plex
{
        ...
        SP_SYS_PRODDIR=/u01/app/quest/shareplex9.4; export SP_SYS_PRODDIR
        SP_SYS_VARDIR=/u01/app/quest/vardir/2100; export SP_SYS_VARDIR
        SP_HOME=/u01/app/quest/shareplex9.4; export SP_HOME
        SP_LIB_PATH=/u01/app/quest/shareplex9.4/lib; export SP_LIB_PATH

--#####################################################################################################################################
--
-- Script Name:        	Cust_DBInfo_v1001.sql
...
-- When:                       2020/10/27
-- Who:			       Clay Jackson,
-- What:           1. Added FLOAT and NVCHAR2 to SQLServer and file supported data types
...
define sqlserver_ok_data_types = "('ANYDATA','BLOB','CHAR','CLOB','DATE','LONG','LONG RAW','NCHAR','NCLOB','NUMBER','NVARCHAR','RAW','VARCHAR2','FLOAT','NVARCHAR2')"
define file_ok_data_types = "('BLOB','CHAR','CLOB','DATE','LONG','LONG RAW','NCHAR','NCLOB','NUMBER','NVARCHAR','RAW','VARCHAR2','VARRAY','FLOAT','NVARCHAR2')"
...
select '10.0.0.1' AS defprogver from dual;
...
select sys_context('USERENV','DB_NAME') AS  defdbname FROM dual; 
...
PROMPT ***
PROMPT ***      NOTE - Version 10 of SharePlex supports Oracle        

...
set heading on;
select a.owner, a.table_name, a.column_name,a.data_type from dba_tab_columns a, dba_objects b
where data_type not in ('ANYDATA','NCLOB','SDO_GEOMETRY','UROWID','XMLTYPE','INTERVAL','BFILE','VARCHAR','VARCHAR2','DATE','NUMBER','NVARCHAR2','LOB','BLOB','CLOB','LONG','LONG RAW','CHAR','ROWID','RAW','FLOAT','NCLOB', 'NCHAR') 
